...
from ..trainer_utils import create_custom_optimizer, create_custom_scheduler, get_batch_logps, nested_detach, get_batch_logps_path
...
class BaseDPOTrainer(DPOTrainer):
    def __init__(
        self,
...
class CustomDPOTrainer(BaseDPOTrainer):

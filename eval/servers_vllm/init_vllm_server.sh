...
start_vllm_server() {
    ...
    VLLM_LOGGING_LEVEL=DEBUG VLLM_USE_MODELSCOPE=false CUDA_VISIBLE_DEVICES=$gpu_id vllm serve /share/project/minghao/Models/Qwen2.5-VL-7B-Instruct \
        --port $port \
...
auto_restart() {
    ...
    local max_restart_attempts=200 
